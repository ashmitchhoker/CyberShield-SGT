...
const GameData = (() => {
  ...
  const TOXIC_WORDS = [
    ...
    'CONNIVING🦊', 'SCHEMING', 'VINDICTIVE', 'RUTHLESS🗡️', 'SADISTIC😈',
    // --- Block 3 ---
    ...
    'DOMINATING🥊', 'FAKE FRIEND👥🚫', 'ATTENTION-HUNGRY🍽️', 'IRRELEVANT', 'OUTCAST🏝️',
  ...
  const SAFE_WORDS = [
    ...
    'GUIDE', 'DEFEND🛡️', 'MEND🧵', 'LOVE YOU💖', 'GOOD JOB👏', 'WELL DONE🌟', 'I CARE', 'BE BRAVE',
